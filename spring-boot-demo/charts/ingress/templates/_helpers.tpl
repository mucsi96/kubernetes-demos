...
{{- if .Chart.AppVersion }}
ingress.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
ingress.kubernetes.io/managed-by: {{ .Release.Service }}
{{- end }}
...
ingress.kubernetes.io/name: {{ include "ingress.name" . }}
ingress.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
